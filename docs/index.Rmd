...
---
background-image:url("https://www.climbing.com/.image/t_share/MTU5MjE0OTg3OTU1NDE0MDg2/free-solo-8.jpg")
background-size: contain
...
---
name: coinceur-mecanique-quatorze-degres

## L'ouverture du coinceur mécanique

```{tikz, echo=FALSE, out.width="90%", fig.align='center', label="coinceur-quatorze-degres"}
\begin{tikzpicture}
...
\foreach \i in {-4,-3,...,6} \draw (\i,-0.1) node[below] {\i} --(\i,0.1);
\foreach \j in {-5,-4,...,2} \draw (-0.1,\j) node[left] {\j} --(0.1,\j);
