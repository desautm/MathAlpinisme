...
> Le facteur de $`r capstan[6,6]`$ ( 5 tours autour d'un cabestan avec un coefficient de friction de 0,6) implique, qu'en théorie, un nouveau-né serait en mesure de retenir (sans bouger) le poids de deux porte-avions de la classe *Nimitz* (97 000 tonnes chacun, mais pour le bébé se serait seulement un peu plus de 1 kg).
...
L'auteur nous met tout de même en garde...
