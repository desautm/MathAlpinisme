...
\draw[->,very thick] (-1.9,-0.34)--(-1.9,0.66) node[midway,left] {$F_f$};
\draw[->,very thick] (-1.9,-0.34)--(-2.9,-0.34) node[midway,below] {$F_n$};
\draw[->,very thick] (-1.9,-0.34)--(-0.9,-0.34) node[midway,below] {$N$};

\draw[->,very thick] (1.9,-0.34)--(1.9,0.66) node[midway,right] {$F_f$};
\draw[->,very thick] (1.9,-0.34)--(2.9,-0.34) node[midway,below] {$F_n$};
\draw[->,very thick] (1.9,-0.34)--(0.9,-0.34) node[midway,below] {$N$};
...
\draw[thick] (3,-1.55)--(3,-3) node[midway, right] {$F_f$};
...
.pull-right[
La force $F$ peut être décomposée en une partie normale $F_n$ et une partie tangentielle (le frottement) $F_f$ à la paroi à l'endroit où le coinceur touche la paroi.
$$
\begin{aligned}
...
Un haltère de 100 livres (`r 100/2.205` kg) suspendu avec $4 \frac{1}{2}$ tours.
